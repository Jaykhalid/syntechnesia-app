            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#prosedur">Prosedur</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#login">Sign In</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact"><i class="fas fa-phone-volume"></i></a></li>
                    </ul>
                </div>
            </div>
        </nav>